...
static const _LeaderState_type_support_symbol_names_t _LeaderState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skyhunter_msgs, msg, LeaderState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, skyhunter_msgs, msg, LeaderState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, skyhunter_msgs, msg, LeaderState)() {
  return &::skyhunter_msgs::msg::rosidl_typesupport_c::LeaderState_message_type_support_handle;
}
