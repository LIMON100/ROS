...
#include "skyhunter_msgs/msg/detail/leader_state__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose__functions.h"  // next_waypoints, pose
...
using _LeaderState__ros_msg_type = skyhunter_msgs__msg__LeaderState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LeaderState__ros_msg_type * ros_message = static_cast<const _LeaderState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: next_waypoints
  {
    ...
    auto array_ptr = ros_message->next_waypoints.data;
  ...
  // Field name: formation_mode
  {
    cdr << ros_message->formation_mode;
  }

  // Field name: formation_state
  {
    cdr << ros_message->formation_state;
  }

  // Field name: swarm_state
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LeaderState__ros_msg_type * ros_message = static_cast<_LeaderState__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: next_waypoints
  {
    ...
    if (ros_message->next_waypoints.data) {
      geometry_msgs__msg__Pose__Sequence__fini(&ros_message->next_waypoints);
    }
    if (!geometry_msgs__msg__Pose__Sequence__init(&ros_message->next_waypoints, size)) {
      fprintf(stderr, "failed to create array for field 'next_waypoints'");
      return false;
    }
    auto array_ptr = ros_message->next_waypoints.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_skyhunter_msgs__msg__LeaderState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LeaderState__ros_msg_type * ros_message = static_cast<const _LeaderState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LeaderState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_skyhunter_msgs__msg__LeaderState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_skyhunter_msgs
size_t max_serialized_size_skyhunter_msgs__msg__LeaderState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = skyhunter_msgs__msg__LeaderState;
    is_plain =
      (
...
static size_t _LeaderState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_skyhunter_msgs__msg__LeaderState(
...
static message_type_support_callbacks_t __callbacks_LeaderState = {
  "skyhunter_msgs::msg",
  "LeaderState",
...
static rosidl_message_type_support_t _LeaderState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LeaderState,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skyhunter_msgs, msg, LeaderState)() {
  return &_LeaderState__type_support;
}
