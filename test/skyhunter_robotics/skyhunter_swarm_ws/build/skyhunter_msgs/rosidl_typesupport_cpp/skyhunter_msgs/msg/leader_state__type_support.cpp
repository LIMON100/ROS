...
static const _LeaderState_type_support_symbol_names_t _LeaderState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skyhunter_msgs, msg, LeaderState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skyhunter_msgs, msg, LeaderState)),
  }
};
...
{
  return &::skyhunter_msgs::msg::rosidl_typesupport_cpp::LeaderState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, skyhunter_msgs, msg, LeaderState)() {
  return get_message_type_support_handle<skyhunter_msgs::msg::LeaderState>();
}
