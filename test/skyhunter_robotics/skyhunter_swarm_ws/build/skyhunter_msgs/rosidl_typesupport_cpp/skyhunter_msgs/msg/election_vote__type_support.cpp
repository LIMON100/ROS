...
static const _ElectionVote_type_support_symbol_names_t _ElectionVote_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skyhunter_msgs, msg, ElectionVote)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skyhunter_msgs, msg, ElectionVote)),
  }
};
...
{
  return &::skyhunter_msgs::msg::rosidl_typesupport_cpp::ElectionVote_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, skyhunter_msgs, msg, ElectionVote)() {
  return get_message_type_support_handle<skyhunter_msgs::msg::ElectionVote>();
}
