...
skyhunter_msgs__msg__LeaderState__init(skyhunter_msgs__msg__LeaderState * msg)
{
  ...
  // next_waypoints
  if (!geometry_msgs__msg__Pose__Sequence__init(&msg->next_waypoints, 0)) {
    skyhunter_msgs__msg__LeaderState__fini(msg);
    return false;
  }
  // formation_mode
...
skyhunter_msgs__msg__LeaderState__fini(skyhunter_msgs__msg__LeaderState * msg)
{
  ...
  // next_waypoints
  geometry_msgs__msg__Pose__Sequence__fini(&msg->next_waypoints);
  // formation_mode
  // formation_state
  // swarm_state
  // formation_type
...
skyhunter_msgs__msg__LeaderState__are_equal(const skyhunter_msgs__msg__LeaderState * lhs, const skyhunter_msgs__msg__LeaderState * rhs)
{
  ...
  if (!geometry_msgs__msg__Pose__Sequence__are_equal(
      &(lhs->next_waypoints), &(rhs->next_waypoints)))
  {
    return false;
  }
  // formation_mode
  ...
  // swarm_state
  if (lhs->swarm_state != rhs->swarm_state) {
    return false;
  }
  // formation_type
  ...
  skyhunter_msgs__msg__LeaderState * output)
{
  ...
  if (!geometry_msgs__msg__Pose__Sequence__copy(
      &(input->next_waypoints), &(output->next_waypoints)))
  {
    return false;
  }
  // formation_mode
  ...
  // swarm_state
  output->swarm_state = input->swarm_state;
  // formation_type
