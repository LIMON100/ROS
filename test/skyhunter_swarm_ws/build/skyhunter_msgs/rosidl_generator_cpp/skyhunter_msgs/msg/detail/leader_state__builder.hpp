...
public:
  ...
  : msg_(msg)
  {}
  ::skyhunter_msgs::msg::LeaderState formation_state(::skyhunter_msgs::msg::LeaderState::_formation_state_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_LeaderState_formation_mode velocity(::skyhunter_msgs::msg::LeaderState::_velocity_type arg)
  {
