        ...
        follower_action = TimerAction(
            ...
            actions=[
                ...
                Node(
                    ...
                    namespace=follower_ns,
                    # Remap to local hardware
                    remappings=[
                        ('/rgb_camera/image_raw', f'/{follower_ns}/rgb_camera/image_raw'),
                        ('/scan/points', f'/{follower_ns}/scan/points'),
                        ('/joint_states', f'/{follower_ns}/joint_states'),
                        ('/gimbal/pan_cmd', f'/{follower_ns}/gimbal/pan_cmd'),
                        ('/gimbal/tilt_cmd', f'/{follower_ns}/gimbal/tilt_cmd'),
                        # Read global leader state to know when to wake up
                        ('/leader_state', '/leader_state')
                    ]
                )
            ]
