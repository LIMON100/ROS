...
def generate_launch_description():
    ...
    base_frame = PythonExpression(["'", namespace, "/base_footprint' if '", namespace, "' != '' else 'base_footprint'"])
    # scan_topic = PythonExpression(["'/", namespace, "/scan/points' if '", namespace, "' != '' else '/scan/points'"])
    scan_topic = PythonExpression(["'/", namespace, "/scan/points_filtered' if '", namespace, "' != '' else '/scan/points_filtered'"])
    ...
    #     # remappings=[('/map', 'map')]   # usually not needed
    # )
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        declare_sim_time, 
        declare_autostart,
        declare_map_cmd,               # ← make sure this is here
        # map_server_node,
