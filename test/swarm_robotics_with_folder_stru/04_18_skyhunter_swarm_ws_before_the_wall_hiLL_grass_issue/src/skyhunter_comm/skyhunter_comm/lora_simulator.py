...
Topics  : /lora/heartbeat  (skyhunter_msgs/LoraHeartbeat, staggered ~1.6 Hz total)
          /lora/status     (skyhunter_msgs/LoraStatus, 0.2 Hz)
          /lora/estop      (skyhunter_msgs/LoraEstop, on-demand)
Services: /lora/send_estop      (skyhunter_msgs/SendEstop)
          /lora/inject_failure  (skyhunter_msgs/InjectFailure)
"""
...
from skyhunter_msgs.msg import LoraHeartbeat, LoraEstop, LoraStatus
from skyhunter_msgs.srv import SendEstop, InjectFailure
