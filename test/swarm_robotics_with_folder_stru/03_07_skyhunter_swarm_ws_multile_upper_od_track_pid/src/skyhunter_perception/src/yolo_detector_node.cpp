...
private:
    ...
    void image_callback(const sensor_msgs::msg::Image::SharedPtr msg) {
        // --- FOLLOWER GPU OPTIMIZATION ---
        // If I am a follower, and there is no combat, DO NOT run YOLO. Stay quiet.
        // if (!is_leader_ && last_swarm_msg_.swarm_state != 3) {
        //     std_msgs::msg::Float64 p; p.data = 0.0; pub_pan_->publish(p); // Look straight
        //     return; 
        // }
