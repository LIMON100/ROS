...
class WaypointFollower(Node):
    def __init__(self):
        ...
        self.waypoints = [
            (-90.5, 90.0),  # 1. Straight ~15m down the highway
            (-80.0,  64.0),  # 2. Straight ~30m down the highway
            (-70.5,  51.0),  # 3. Straight ~45m down the highway
            (-60.0,  38.0)   # 4. Straight ~60m down the highway
        ]
