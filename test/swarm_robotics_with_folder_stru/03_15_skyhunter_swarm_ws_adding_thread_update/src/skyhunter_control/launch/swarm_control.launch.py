"""
this launch file is designed to start the swarm control nodes for all 8 robots in the V-Shape formation. It reads the formation configuration from a YAML file and launches the leader and follower nodes with the appropriate parameters.
"""
import os
import yaml
