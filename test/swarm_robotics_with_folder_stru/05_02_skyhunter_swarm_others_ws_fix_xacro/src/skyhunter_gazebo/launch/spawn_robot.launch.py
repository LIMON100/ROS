...
def spawn_robot(
    ...
    # Default z is just above ground. Wheel-bottom is at ~z=-0.003 in
    # base_footprint frame, so 0.05 m is enough clearance without producing
    # a ~0.5 m free-fall transient that excites the IMU on spawn.
    z_value = pose_parts[2] if len(pose_parts) > 2 else "0.05"
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("pose", default_value="0 0 0.05"),
