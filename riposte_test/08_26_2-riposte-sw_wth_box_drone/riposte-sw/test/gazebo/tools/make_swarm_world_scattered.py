...
TARGETS = [
    # name       x     y     z    vx     vy   vz
    ("drone_1",  28.0,   2.0, 5.0, -0.45, -0.05, 0.0),
    ("drone_2",  20.0,  22.0, 5.5, -0.35, -0.40, 0.0),
    ("drone_3",  18.0, -24.0, 4.5, -0.30,  0.45, 0.0),
    ("drone_4", -26.0,  12.0, 6.0,  0.50, -0.25, 0.0),
    ("drone_5", -14.0, -20.0, 4.5,  0.30,  0.40, 0.0),
]   
