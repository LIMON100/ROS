...
track them all at once:
  ...
  <sdf version="1.9">
    <world name="{world}">
      ...
      <model name="ground_features">
          <static>true</static>
          <link name="link">
            <visual name="a"><pose>10 -7 0.5 0 0 0</pose><geometry><box><size>2 2 1</size></box></geometry><material><ambient>0.7 0.2
  0.1 1</ambient><diffuse>0.7 0.2 0.1 1</diffuse></material></visual>
            <visual name="b"><pose>16 5 0.5 0 0 0</pose><geometry><box><size>3 2 1</size></box></geometry><material><ambient>0.1 0.1 0.6
  1</ambient><diffuse>0.1 0.1 0.6 1</diffuse></material></visual>
            <visual name="c"><pose>24 -12 0.5 0 0 0</pose><geometry><box><size>2 3 1</size></box></geometry><material><ambient>0.8 0.7
  0.1 1</ambient><diffuse>0.8 0.7 0.1 1</diffuse></material></visual>
            <visual name="d"><pose>30 9 0.5 0 0 0</pose><geometry><box><size>2 2 1</size></box></geometry><material><ambient>0.2 0.6 0.2
  1</ambient><diffuse>0.2 0.6 0.2 1</diffuse></material></visual>
            <visual name="e"><pose>38 -4 0.5 0 0 0</pose><geometry><box><size>3 3 1</size></box></geometry><material><ambient>0.6 0.1
  0.6 1</ambient><diffuse>0.6 0.1 0.6 1</diffuse></material></visual>
            <visual name="f"><pose>20 -18 0.5 0 0 0</pose><geometry><box><size>2 2 1</size></box></geometry><material><ambient>0.9 0.9
  0.9 1</ambient><diffuse>0.9 0.9 0.9 1</diffuse></material></visual>
          </link>
        </model>
