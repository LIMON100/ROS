...
Topics  : /lte_status  (san_comm_msgs/LteStatus, 2 Hz)
Services: /lte/inject_failure  (san_comm_msgs/InjectFailure)
"""
...
from san_comm_msgs.msg import LteStatus
from san_comm_msgs.srv import InjectFailure
