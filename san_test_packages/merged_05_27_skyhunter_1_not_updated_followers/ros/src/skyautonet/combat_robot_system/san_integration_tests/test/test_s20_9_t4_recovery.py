...
class T4Probe(Node):
    def __init__(self):
        ...
        # tier_node subscribes to the fleet-wide /swarm/robot_status
        # topic (Phase 6 patch — see tier_node.cpp:63). The probe must
        # publish there, not on the legacy ~/robot_status private topic
        # which has no producer in the current system.
