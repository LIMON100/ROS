...
private:
    ...
    combat_robot_msgs::msg::LeaderState last_swarm_msg_;
    ...
    rclcpp::Subscription<combat_robot_msgs::msg::LeaderState>::SharedPtr sub_swarm_state_;
    
    // Vote Subscriber
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr sub_confirm_; 

    // Publishers
    // rclcpp::Publisher<combat_robot_msgs::msg::LeaderState>::SharedPtr pub_leader_state_;
    rclcpp::Publisher<combat_robot_msgs::msg::LeaderState>::SharedPtr pub_combat_state_;
    rclcpp::Publisher<combat_robot_msgs::msg::DetectionArray>::SharedPtr pub_detections_;
