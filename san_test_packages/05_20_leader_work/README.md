...
**Latest release:** [`v1.4.0`](https://github.com/adasone/SH_Unitree_Patrol/releases/tag/v1.4.0) — 2026-05-12
(v1.5 PDR-prep는 main 직접 통합 진행 중, GA 태깅 예정)
...
- **Tier 3 (Python rclpy)** — perception (AI inference seam) / mission
  (Behavior Tree) / BLE control / operator tools.
...
│
│ ── Tier 2: C++ 동작 로직 ────────────────────────────
├── san_fire_authorization/         # HMAC + Two-key + Audit (D-004)
