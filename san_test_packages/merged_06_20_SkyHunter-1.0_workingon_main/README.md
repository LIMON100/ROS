...
운용을 위한 ROS 2 Jazzy 스택. v1.4 의 **Hub-Deputy 이중화 + 4-tier
...
| **S2** | **Hub UGV** | **듀얼 RK3588** | Leader 승계 2순위, LTE 1차, SLAM aggregation, GStreamer SRT relay |
| **S3** | **Deputy UGV ★v1.4** | **듀얼 RK3588** (Hub 와 동일) | Leader 승계 1순위, Hub 인수 1순위 |
...
| Workflow | 트리거 | 내용 |
|---|---|---|
| `ros2-ci.yml` | PR / push | colcon build + test (Jazzy, ubuntu-24.04) |
...
| `arm64.yml` | release | cross-build for RK3588 (Boardcon EM3588) |
