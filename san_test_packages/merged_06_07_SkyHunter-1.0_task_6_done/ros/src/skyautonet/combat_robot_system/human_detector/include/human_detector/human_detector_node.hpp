...
private:
  ...
  std::string thermal_topic_;        // empty = thermal fusion off (sim)
  double thermal_scale_ = 0.01;      // raw→°C scale (centikelvin)
  double thermal_offset_ = -273.15;  // raw→°C offset
  double thermal_stale_sec_ = 0.5;
  ...
  rclcpp::Publisher<combat_robot_msgs::msg::DetectionArray>::SharedPtr det_pub_;
  rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr debug_image_pub_;
  rclcpp::Subscription<sensor_msgs::msg::Image>::SharedPtr thermal_sub_;
  cv::Mat latest_thermal_;           // CV_16UC1
  rclcpp::Time latest_thermal_stamp_{0, 0, RCL_ROS_TIME};
  ...
  void onThermal(sensor_msgs::msg::Image::SharedPtr msg);
  void onHealthTick();
