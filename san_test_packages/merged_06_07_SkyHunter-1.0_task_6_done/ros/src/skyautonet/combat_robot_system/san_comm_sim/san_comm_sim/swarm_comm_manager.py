...
Topic   : /comm_state  (san_comm_msgs/CommState, 2 Hz)
"""
...
from san_comm_msgs.msg import CommState, LteStatus, LoraStatus, MeshMetrics

from san_comm_sim.models.comm_fsm import CommFSM, CommFSMParams, TIER_NAMES
from san_comm_sim.models.health_evaluators import (
    evaluate_wifi6,
