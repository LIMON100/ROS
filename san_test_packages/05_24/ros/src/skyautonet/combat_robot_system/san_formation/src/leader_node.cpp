...
#include "san_formation/leader_node.hpp"
#include <cmath>
#include <limits>
...
LeaderNode::LeaderNode(const rclcpp::NodeOptions & options) : Node("leader_node", options) {
  ...
  publisher_ = this->create_publisher<combat_robot_msgs::msg::LeaderState>("/leader_state", 10);
  ...
  sub_combat_state_ = this->create_subscription<combat_robot_msgs::msg::LeaderState>("perception/combat_state", qos, std::bind(&LeaderNode::combat_state_callback, this, std::placeholders::_1));
...
void LeaderNode::combat_state_callback(const combat_robot_msgs::msg::LeaderState::SharedPtr msg) { latest_combat_state_ = *msg; }
...
void LeaderNode::timer_callback() {
  ...
  auto state_msg = combat_robot_msgs::msg::LeaderState();
