...
|---|---|---|---|
| `EmergencyStop` | E-stop | OperatorUI | mission_node (P0) |
...
> **Note**: `BleCommand` + `BlePhaseStatus` 메시지는 DCN-2026-008 (BLE removal) + DCN-2026-023 v2 로 완전 삭제됨. 운용자 명령은 WiFi 채널 (FormationCommand, ManualOverrideCommand, MissionStateCommand 등) 사용.
