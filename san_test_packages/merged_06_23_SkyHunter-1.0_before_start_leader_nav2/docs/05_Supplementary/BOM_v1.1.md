...
> **갱신 (DCN-2026-027, 2026-06-15)**: 메인 개발보드가 Custom RK3588J 보드 →
> **Boardcon EM3588 (Rockchip RK3588, 비-J)** 로 교체됨 (PM 결정). 아래 표의
> SBC `RK3588J` 항목은 **현재 RK3588 (비-J)** 로 적용한다. ⚠ RK3588 은 일반
> 등급(약 0~80℃)으로 **산업용 RK3588J(−40~85℃) 대비 옥외 운용 온도 derating**
> 발생 — enclosure 방열/히터 보강 또는 J-grade SKU 채택 등 운용 온도 사양 재검토
> 필요. (표의 v1.0 열 표기는 변경 이력 보존 차원에서 유지.)
