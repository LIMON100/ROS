...
struct ThreatInput
{
  ...
  // DCN-2026-026 C-2 — spatial localization passthrough. The
  // aggregated /hub/threat_alert previously dropped these (formation /
  // surveillance consumers lost the threat position after dedup).
  bool has_position = false;
  float bearing_deg = 0.0f;     // world-frame (DCN-2026-010)
...
struct ThreatOutput
{
  ...
  // DCN-2026-026 C-2 — latest spatial fix folded into this slot.
  bool has_position = false;
