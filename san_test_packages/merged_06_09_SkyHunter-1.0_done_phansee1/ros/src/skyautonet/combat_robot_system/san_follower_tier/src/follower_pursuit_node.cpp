...
public:
  ...
  : rclcpp::Node("follower_pursuit_node")
  {
    ...
    // slot_follow_ = declare_parameter<bool>("slot_follow", false);
    // slot_timeout_s_ = declare_parameter<double>("slot_timeout_s", 1.0);
    ...
    //     "/swarm/encircle_target", rclcpp::QoS(10).reliable(),
