...
def spawn_robot(
    ...
    # Feed the unique model name into the URDF so the SDF <model name> is unique
    # per robot (otherwise the gz GUI renders only one of two identical models).
