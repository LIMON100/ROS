...
> **Note** (DCN-2026-008 + DCN-2026-023 v2): `san_ble_control` 패키지 +
> 13 BLE pytest 모두 삭제됨 — App 연동은 전적으로 WiFi
> (rosbridge_server). 본 표의 카운트 갱신됨.
...
`osrf/ros:jazzy-desktop` 컨테이너에서 전체 워크스페이스 빌드 + 테스트.
