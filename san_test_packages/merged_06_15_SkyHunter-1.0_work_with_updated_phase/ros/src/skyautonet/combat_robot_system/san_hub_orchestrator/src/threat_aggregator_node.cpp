  ...
  const ThreatMsg::SharedPtr msg)
{
  ...
  in.has_position = msg->has_position;
  in.bearing_deg = msg->bearing_deg;
  in.elevation_deg = msg->elevation_deg;
  in.range_m = msg->range_m;
...
void ThreatAggregatorNode::publish(const ThreatOutput & t)
{
  ...
  msg.has_position = t.has_position;
  msg.bearing_deg = t.bearing_deg;
