...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "convoy_coordinator = san_operator_tools.convoy_coordinator:main",
            "convoy_ugv         = san_operator_tools.convoy_ugv:main",
            "convoy_viz         = san_operator_tools.convoy_viz:main",
            "convoy_costmap     = san_operator_tools.convoy_costmap:main",
            "convoy_nav2_follower = san_operator_tools.convoy_nav2_follower:main",
            "sensor_load_probe = san_operator_tools.sensor_load_probe:main",
        ],
    },
)
