...
def _setup(context, *args, **kwargs):
    ...
    # Route is a loop kept well inside the walled arena (±10 m, walls at
    # ±15 m) so the robots start at the centre and stay in view the whole run.
    leader_nav = Node(
        ...
        parameters=[{
            ...
            "max_angular_rps": 1.2,
            # Complex loop route (low wheel mu2 lets the skid-steer turn the
            # corners). Stays within ±10 m; arena walls are at ±22 m.
            "waypoints": [10.0, 0.0, 10.0, 10.0, -10.0, 10.0,
