...
YoloDetectorNode::YoloDetectorNode() : Node("yolo_detector_node") {
    ...
    sub_swarm_state_ = this->create_subscription<combat_robot_msgs::msg::LeaderState>("/leader_state", 10, [this](const combat_robot_msgs::msg::LeaderState::SharedPtr msg) { last_swarm_msg_ = *msg; });
    ...
    if (is_leader_) {
        ...
        // pub_leader_state_ = this->create_publisher<combat_robot_msgs::msg::LeaderState>("leader_state", 10);
        pub_combat_state_ = this->create_publisher<combat_robot_msgs::msg::LeaderState>("perception/combat_state", 10);
    ...
    pub_detections_ = this->create_publisher<combat_robot_msgs::msg::DetectionArray>("swarm/detections", 10);
...
void YoloDetectorNode::image_callback(const sensor_msgs::msg::Image::SharedPtr msg) {
    ...
    combat_robot_msgs::msg::DetectionArray det_msg;
    ...
    if (ai_sees_target) {
        ...
        for (size_t i = 0; i < tracked_targets.size(); ++i) {
            ...
            combat_robot_msgs::msg::Detection det;
            ...
            if ((int)i == best_idx) {
                ...
                if (is_leader_) {
                    combat_robot_msgs::msg::LeaderState state_msg;
        ...
        if (in_halt_mode_) {
            ...
            combat_robot_msgs::msg::LeaderState empty_state_msg;
