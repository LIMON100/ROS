...
private:
  ...
  combat_robot_msgs::msg::LeaderState latest_combat_state_;
  rclcpp::Subscription<combat_robot_msgs::msg::LeaderState>::SharedPtr sub_combat_state_;
  void combat_state_callback(const combat_robot_msgs::msg::LeaderState::SharedPtr msg);
  ...
  rclcpp::Publisher<combat_robot_msgs::msg::LeaderState>::SharedPtr publisher_;
