...
TEST(AutoRateController, GradeToQualityMapping) {
  ...
  EXPECT_EQ(
    AR::gradeToQuality(Lq::LTE_GRADE_EXCELLENT, Req::QUALITY_FHD),
    Req::QUALITY_FHD);
  EXPECT_EQ(
    AR::gradeToQuality(Lq::LTE_GRADE_GOOD, Req::QUALITY_FHD),
    Req::QUALITY_HD);
  EXPECT_EQ(
    AR::gradeToQuality(Lq::LTE_GRADE_FAIR, Req::QUALITY_FHD),
    Req::QUALITY_LOW);
  EXPECT_EQ(
    AR::gradeToQuality(Lq::LTE_GRADE_POOR, Req::QUALITY_FHD),
...
TEST(AutoRateController, CeilingCapsExcellent) {
  using AR = AutoRateController;
  EXPECT_EQ(
    AR::gradeToQuality(Lq::LTE_GRADE_EXCELLENT, Req::QUALITY_HD),
    Req::QUALITY_HD)
