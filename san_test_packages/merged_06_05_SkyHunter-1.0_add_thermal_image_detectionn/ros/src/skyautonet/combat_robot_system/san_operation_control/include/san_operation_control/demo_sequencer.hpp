...
public:
  ...
  void disable();
  // Audit A2 (P2) — was inline `return enabled_` (no lock) — torn read
  // possible if disable()/enableForMode() ran concurrently from another
  // thread under MultiThreadedExecutor. Now lock-protected.
