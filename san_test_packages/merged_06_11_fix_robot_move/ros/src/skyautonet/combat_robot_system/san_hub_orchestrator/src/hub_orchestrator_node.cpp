  ...
  aggregator_(5000)
{
  ...
  status_sub_ = create_subscription<RobotStatusMsg>(
    ...
    std::bind(
      &HubOrchestratorNode::onRobotStatus, this,
      std::placeholders::_1));
  ...
  const RobotStatusMsg::SharedPtr msg)
{
  ...
  // TODO(skyautonet) Turn 14-15: subscribe per-robot rtk_status to refine.
...
void HubOrchestratorNode::onTick()
{
  ...
  msg.follower_map_tiles_received = 0;       // TODO(skyautonet) Turn 14-15
