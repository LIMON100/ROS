...
#define NODE_MAIN_LOGGER_NAME "swarm_coordinator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libswarm_coordinator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<swarm_coordinator::SwarmCoordinatorNode>";
