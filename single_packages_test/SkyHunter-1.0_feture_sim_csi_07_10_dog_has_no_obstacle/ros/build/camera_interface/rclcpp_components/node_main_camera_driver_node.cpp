...
#define NODE_MAIN_LOGGER_NAME "camera_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcamera_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<camera_interface::CameraDriver>";
