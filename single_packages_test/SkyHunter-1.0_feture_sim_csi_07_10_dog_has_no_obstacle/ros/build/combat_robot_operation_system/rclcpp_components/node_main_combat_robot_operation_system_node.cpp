...
#define NODE_MAIN_LOGGER_NAME "combat_robot_operation_system_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcombat_robot_operation_system.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<combat_robot_system::CombatRobotOperationSystem>";
