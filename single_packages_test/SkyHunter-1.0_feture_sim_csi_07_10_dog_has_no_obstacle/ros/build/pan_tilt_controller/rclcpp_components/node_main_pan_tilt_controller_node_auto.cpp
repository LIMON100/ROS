...
#define NODE_MAIN_LOGGER_NAME "pan_tilt_controller_node_auto"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpan_tilt_controller.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<combat_robot_system::PanTiltController>";
