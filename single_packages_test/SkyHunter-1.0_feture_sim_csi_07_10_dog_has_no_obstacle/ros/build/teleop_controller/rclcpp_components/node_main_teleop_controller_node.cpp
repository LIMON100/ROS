...
#define NODE_MAIN_LOGGER_NAME "teleop_controller_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libteleop_controller.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<teleop_controller::RobotController>";
