...
bool combat_robot_msgs__msg__swarm_path_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("combat_robot_msgs.msg._swarm_path_command.SwarmPathCommand", full_classname_dest, 58) == 0);
  }
  combat_robot_msgs__msg__SwarmPathCommand * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SwarmPathCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("combat_robot_msgs.msg._swarm_path_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SwarmPathCommand");
