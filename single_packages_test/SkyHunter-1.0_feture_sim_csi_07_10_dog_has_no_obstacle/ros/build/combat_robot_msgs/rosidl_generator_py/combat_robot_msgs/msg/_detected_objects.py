    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'combat_robot_msgs.msg.DetectedObjects')
            logger.debug(
            ...
            from combat_robot_msgs.msg import DetectedObject
...
class DetectedObjects(metaclass=Metaclass_DetectedObjects):
    ...
    _fields_and_field_types = {
        ...
        'image_width': 'int32',
        'image_height': 'int32',
        'objects': 'sequence<combat_robot_msgs/DetectedObject>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('int32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['combat_robot_msgs', 'msg'], 'DetectedObject')),  # noqa: E501
    )
