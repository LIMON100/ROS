...
class Metaclass_SwarmControlCommand(type):
    """Metaclass of message 'SwarmControlCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'combat_robot_msgs.msg.SwarmControlCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__swarm_control_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__swarm_control_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__swarm_control_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__swarm_control_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__swarm_control_command
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'FORMATION_NONE': cls.__constants['FORMATION_NONE'],
            'FORMATION_RECON': cls.__constants['FORMATION_RECON'],
            'FORMATION_PROTECT': cls.__constants['FORMATION_PROTECT'],
            'FORMATION_ASSAULT': cls.__constants['FORMATION_ASSAULT'],
        }

    @property
    def FORMATION_NONE(self):
        """Message constant 'FORMATION_NONE'."""
        return Metaclass_SwarmControlCommand.__constants['FORMATION_NONE']

    @property
    def FORMATION_RECON(self):
        """Message constant 'FORMATION_RECON'."""
        return Metaclass_SwarmControlCommand.__constants['FORMATION_RECON']

    @property
    def FORMATION_PROTECT(self):
        """Message constant 'FORMATION_PROTECT'."""
        return Metaclass_SwarmControlCommand.__constants['FORMATION_PROTECT']

    @property
    def FORMATION_ASSAULT(self):
        """Message constant 'FORMATION_ASSAULT'."""
        return Metaclass_SwarmControlCommand.__constants['FORMATION_ASSAULT']


class SwarmControlCommand(metaclass=Metaclass_SwarmControlCommand):
    """
    Message class 'SwarmControlCommand'.
