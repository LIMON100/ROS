...
bool combat_robot_msgs__msg__swarm_leader_heartbeat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("combat_robot_msgs.msg._swarm_leader_heartbeat.SwarmLeaderHeartbeat", full_classname_dest, 66) == 0);
  }
  combat_robot_msgs__msg__SwarmLeaderHeartbeat * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of SwarmLeaderHeartbeat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("combat_robot_msgs.msg._swarm_leader_heartbeat");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SwarmLeaderHeartbeat");
