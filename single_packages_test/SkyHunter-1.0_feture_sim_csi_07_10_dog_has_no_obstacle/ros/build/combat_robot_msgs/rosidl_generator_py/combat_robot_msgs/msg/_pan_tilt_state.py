...
class Metaclass_PanTiltState(type):
    """Metaclass of message 'PanTiltState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'combat_robot_msgs.msg.PanTiltState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__pan_tilt_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__pan_tilt_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__pan_tilt_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__pan_tilt_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__pan_tilt_state
...
class PanTiltState(metaclass=Metaclass_PanTiltState):
    """Message class 'PanTiltState'."""
    ...
    def pan_speed(self, value):
        if self._check_fields:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'pan_speed' field must be an integer in [-2147483648, 2147483647]"
