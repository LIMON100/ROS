...
bool combat_robot_msgs__msg__drive_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("combat_robot_msgs.msg._drive_command.DriveCommand", full_classname_dest, 49) == 0);
  }
  combat_robot_msgs__msg__DriveCommand * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of DriveCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("combat_robot_msgs.msg._drive_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DriveCommand");
