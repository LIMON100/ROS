...
static const _SwarmLeaderHeartbeat_type_support_symbol_names_t _SwarmLeaderHeartbeat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, combat_robot_msgs, msg, SwarmLeaderHeartbeat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, combat_robot_msgs, msg, SwarmLeaderHeartbeat)),
  }
};
...
{
  return &::combat_robot_msgs::msg::rosidl_typesupport_cpp::SwarmLeaderHeartbeat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, combat_robot_msgs, msg, SwarmLeaderHeartbeat)() {
  return get_message_type_support_handle<combat_robot_msgs::msg::SwarmLeaderHeartbeat>();
}
