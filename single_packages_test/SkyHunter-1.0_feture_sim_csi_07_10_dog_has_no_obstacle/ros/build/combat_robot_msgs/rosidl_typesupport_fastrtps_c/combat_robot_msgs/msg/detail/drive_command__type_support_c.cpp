...
#include "combat_robot_msgs/msg/detail/drive_command__rosidl_typesupport_fastrtps_c.h"
...
using _DriveCommand__ros_msg_type = combat_robot_msgs__msg__DriveCommand;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_combat_robot_msgs
bool cdr_serialize_combat_robot_msgs__msg__DriveCommand(
  const combat_robot_msgs__msg__DriveCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_combat_robot_msgs
bool cdr_deserialize_combat_robot_msgs__msg__DriveCommand(
  eprosima::fastcdr::Cdr & cdr,
  combat_robot_msgs__msg__DriveCommand * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_combat_robot_msgs
size_t get_serialized_size_combat_robot_msgs__msg__DriveCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_combat_robot_msgs
size_t max_serialized_size_combat_robot_msgs__msg__DriveCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs__msg__DriveCommand;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_combat_robot_msgs
bool cdr_serialize_key_combat_robot_msgs__msg__DriveCommand(
  const combat_robot_msgs__msg__DriveCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_combat_robot_msgs
size_t get_serialized_size_key_combat_robot_msgs__msg__DriveCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DriveCommand__ros_msg_type * ros_message = static_cast<const _DriveCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_combat_robot_msgs
size_t max_serialized_size_key_combat_robot_msgs__msg__DriveCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const combat_robot_msgs__msg__DriveCommand * ros_message = static_cast<const combat_robot_msgs__msg__DriveCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_combat_robot_msgs__msg__DriveCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  combat_robot_msgs__msg__DriveCommand * ros_message = static_cast<combat_robot_msgs__msg__DriveCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_combat_robot_msgs__msg__DriveCommand(cdr, ros_message);
}

static uint32_t _DriveCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_combat_robot_msgs__msg__DriveCommand(
...
static size_t _DriveCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_combat_robot_msgs__msg__DriveCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, combat_robot_msgs, msg, DriveCommand)() {
