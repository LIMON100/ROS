...
#include "combat_robot_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_c.h"
...
using _DetectedObject__ros_msg_type = combat_robot_msgs__msg__DetectedObject;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs__msg__DetectedObject;
    is_plain =
      (
      offsetof(DataType, box) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const combat_robot_msgs__msg__DetectedObject * ros_message = static_cast<const combat_robot_msgs__msg__DetectedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_combat_robot_msgs__msg__DetectedObject(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  combat_robot_msgs__msg__DetectedObject * ros_message = static_cast<combat_robot_msgs__msg__DetectedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_combat_robot_msgs__msg__DetectedObject(cdr, ros_message);
}

static uint32_t _DetectedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_combat_robot_msgs__msg__DetectedObject(
...
static size_t _DetectedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_combat_robot_msgs__msg__DetectedObject(
