...
#include "combat_robot_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoint__ros_msg_type = combat_robot_msgs__msg__Waypoint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs__msg__Waypoint;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const combat_robot_msgs__msg__Waypoint * ros_message = static_cast<const combat_robot_msgs__msg__Waypoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_combat_robot_msgs__msg__Waypoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  combat_robot_msgs__msg__Waypoint * ros_message = static_cast<combat_robot_msgs__msg__Waypoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_combat_robot_msgs__msg__Waypoint(cdr, ros_message);
}

static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_combat_robot_msgs__msg__Waypoint(
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_combat_robot_msgs__msg__Waypoint(
