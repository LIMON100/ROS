...
#ifndef COMBAT_ROBOT_MSGS__MSG__DETAIL__GNSS_STATUS__TYPE_SUPPORT_H_
#define COMBAT_ROBOT_MSGS__MSG__DETAIL__GNSS_STATUS__TYPE_SUPPORT_H_
...
#endif  // COMBAT_ROBOT_MSGS__MSG__DETAIL__GNSS_STATUS__TYPE_SUPPORT_H_
