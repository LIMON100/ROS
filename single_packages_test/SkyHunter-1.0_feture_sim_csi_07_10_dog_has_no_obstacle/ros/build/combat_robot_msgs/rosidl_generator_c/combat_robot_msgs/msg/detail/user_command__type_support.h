...
#ifndef COMBAT_ROBOT_MSGS__MSG__DETAIL__USER_COMMAND__TYPE_SUPPORT_H_
#define COMBAT_ROBOT_MSGS__MSG__DETAIL__USER_COMMAND__TYPE_SUPPORT_H_
...
#endif  // COMBAT_ROBOT_MSGS__MSG__DETAIL__USER_COMMAND__TYPE_SUPPORT_H_
