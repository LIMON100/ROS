...
{
  new (message_memory) combat_robot_msgs::msg::DetectedObject(_init);
}

void DetectedObject_fini_function(void * message_memory)
{
  auto typed_message = static_cast<combat_robot_msgs::msg::DetectedObject *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectedObject_message_member_array[3] = {
  {
    ...
    offsetof(combat_robot_msgs::msg::DetectedObject, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(combat_robot_msgs::msg::DetectedObject, prob),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<combat_robot_msgs::msg::BoundingBox2d>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(combat_robot_msgs::msg::DetectedObject, box),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectedObject_message_members = {
  ...
  3,  // number of fields
  sizeof(combat_robot_msgs::msg::DetectedObject),
...
get_message_type_support_handle<combat_robot_msgs::msg::DetectedObject>()
{
  return &::combat_robot_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, combat_robot_msgs, msg, DetectedObject)() {
  return &::combat_robot_msgs::msg::rosidl_typesupport_introspection_cpp::DetectedObject_message_type_support_handle;
}
