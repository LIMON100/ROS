...
#include "combat_robot_msgs/msg/detail/drive_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const combat_robot_msgs::msg::DriveCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  combat_robot_msgs::msg::DriveCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs::msg::DriveCommand;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_combat_robot_msgs
max_serialized_size_key_DriveCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::DriveCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<combat_robot_msgs::msg::DriveCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DriveCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::DriveCommand *>(
...
static size_t _DriveCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DriveCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DriveCommand__callbacks = {
...
static rosidl_message_type_support_t _DriveCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DriveCommand__callbacks,
...
{
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_DriveCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, combat_robot_msgs, msg, DriveCommand)() {
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_DriveCommand__handle;
}
