...
#include "combat_robot_msgs/msg/detail/bounding_box2d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const combat_robot_msgs::msg::BoundingBox2d & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  combat_robot_msgs::msg::BoundingBox2d & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs::msg::BoundingBox2d;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::BoundingBox2d *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<combat_robot_msgs::msg::BoundingBox2d *>(
    untyped_ros_message);
...
{
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2d__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, combat_robot_msgs, msg, BoundingBox2d)() {
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2d__handle;
}
