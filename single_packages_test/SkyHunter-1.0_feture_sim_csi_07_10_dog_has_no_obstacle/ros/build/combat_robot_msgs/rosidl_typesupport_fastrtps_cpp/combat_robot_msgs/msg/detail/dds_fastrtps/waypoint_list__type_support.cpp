...
#include "combat_robot_msgs/msg/detail/waypoint_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const combat_robot_msgs::msg::Waypoint &,
...
cdr_serialize(
  const combat_robot_msgs::msg::WaypointList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  combat_robot_msgs::msg::WaypointList & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        combat_robot_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Waypoint(
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs::msg::WaypointList;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: waypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        combat_robot_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Waypoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::WaypointList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<combat_robot_msgs::msg::WaypointList *>(
    untyped_ros_message);
...
{
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, combat_robot_msgs, msg, WaypointList)() {
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_WaypointList__handle;
}
