...
#include "combat_robot_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const combat_robot_msgs::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  combat_robot_msgs::msg::DetectedObject & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<combat_robot_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, combat_robot_msgs, msg, DetectedObject)() {
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
