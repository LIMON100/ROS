...
#include "combat_robot_msgs/msg/detail/touch_target_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const combat_robot_msgs::msg::TouchTargetPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  combat_robot_msgs::msg::TouchTargetPoint & ros_message)
{
  // Member: touch_x
  cdr >> ros_message.touch_x;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_combat_robot_msgs
max_serialized_size_TouchTargetPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs::msg::TouchTargetPoint;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_combat_robot_msgs
max_serialized_size_key_TouchTargetPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::TouchTargetPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<combat_robot_msgs::msg::TouchTargetPoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TouchTargetPoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::TouchTargetPoint *>(
...
static size_t _TouchTargetPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TouchTargetPoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TouchTargetPoint__callbacks = {
...
static rosidl_message_type_support_t _TouchTargetPoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TouchTargetPoint__callbacks,
...
{
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_TouchTargetPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, combat_robot_msgs, msg, TouchTargetPoint)() {
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_TouchTargetPoint__handle;
}
