...
#include "combat_robot_msgs/msg/detail/swarm_leader_heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const combat_robot_msgs::msg::SwarmLeaderHeartbeat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  combat_robot_msgs::msg::SwarmLeaderHeartbeat & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_combat_robot_msgs
max_serialized_size_SwarmLeaderHeartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = combat_robot_msgs::msg::SwarmLeaderHeartbeat;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_combat_robot_msgs
max_serialized_size_key_SwarmLeaderHeartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::SwarmLeaderHeartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<combat_robot_msgs::msg::SwarmLeaderHeartbeat *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SwarmLeaderHeartbeat__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const combat_robot_msgs::msg::SwarmLeaderHeartbeat *>(
...
static size_t _SwarmLeaderHeartbeat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SwarmLeaderHeartbeat(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SwarmLeaderHeartbeat__callbacks = {
...
static rosidl_message_type_support_t _SwarmLeaderHeartbeat__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SwarmLeaderHeartbeat__callbacks,
...
{
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_SwarmLeaderHeartbeat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, combat_robot_msgs, msg, SwarmLeaderHeartbeat)() {
  return &combat_robot_msgs::msg::typesupport_fastrtps_cpp::_SwarmLeaderHeartbeat__handle;
}
