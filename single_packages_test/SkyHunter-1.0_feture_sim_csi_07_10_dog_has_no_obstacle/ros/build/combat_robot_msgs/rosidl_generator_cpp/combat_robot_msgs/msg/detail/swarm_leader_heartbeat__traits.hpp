...
#ifndef COMBAT_ROBOT_MSGS__MSG__DETAIL__SWARM_LEADER_HEARTBEAT__TRAITS_HPP_
#define COMBAT_ROBOT_MSGS__MSG__DETAIL__SWARM_LEADER_HEARTBEAT__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const SwarmLeaderHeartbeat & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
...
inline std::string to_yaml(const SwarmLeaderHeartbeat & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const combat_robot_msgs::msg::SwarmLeaderHeartbeat & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const combat_robot_msgs::msg::SwarmLeaderHeartbeat & msg)
{
  return combat_robot_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<combat_robot_msgs::msg::SwarmLeaderHeartbeat>()
{
  return "combat_robot_msgs::msg::SwarmLeaderHeartbeat";
}

template<>
inline const char * name<combat_robot_msgs::msg::SwarmLeaderHeartbeat>()
{
  return "combat_robot_msgs/msg/SwarmLeaderHeartbeat";
}

template<>
struct has_fixed_size<combat_robot_msgs::msg::SwarmLeaderHeartbeat>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<combat_robot_msgs::msg::SwarmLeaderHeartbeat>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<combat_robot_msgs::msg::SwarmLeaderHeartbeat>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // COMBAT_ROBOT_MSGS__MSG__DETAIL__SWARM_LEADER_HEARTBEAT__TRAITS_HPP_
