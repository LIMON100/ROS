...
static const _TouchTargetPoint_type_support_symbol_names_t _TouchTargetPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, combat_robot_msgs, msg, TouchTargetPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, combat_robot_msgs, msg, TouchTargetPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, combat_robot_msgs, msg, TouchTargetPoint)() {
  return &::combat_robot_msgs::msg::rosidl_typesupport_c::TouchTargetPoint_message_type_support_handle;
}
