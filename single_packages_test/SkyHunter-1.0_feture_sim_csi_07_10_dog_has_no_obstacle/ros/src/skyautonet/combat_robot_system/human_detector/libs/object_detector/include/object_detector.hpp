...
public:
    HailoNmsDetector(std::string hef_path, float box_thres=0.25, bool show_info=true);

    HailoNmsDetector(const HailoNmsDetector&) = delete;
    HailoNmsDetector(HailoNmsDetector&& other) noexcept;

    ~HailoNmsDetector() {};

    HailoNmsDetector& operator=(const HailoNmsDetector&) = delete;
    HailoNmsDetector& operator=(HailoNmsDetector&& other) noexcept;
