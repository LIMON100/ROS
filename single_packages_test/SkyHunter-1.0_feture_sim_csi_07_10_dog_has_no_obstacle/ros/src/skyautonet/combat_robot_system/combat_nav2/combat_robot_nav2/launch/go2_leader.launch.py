...
def generate_launch_description():
    ...
    quadruped_controller = Node(
        ...
        # remappings=[('/cmd_vel/smooth', f'/{ns}/cmd_vel')])
    ...
    bridge = Node(  
        ...
        #     ('/odom_gt', f'/{ns}/odom'),
        #     ('/gps/fix', f'/{ns}/fix'),
        #     ('/imu/data', f'/{ns}/gps/heading_imu'),
        #     ('/unitree_lidar/points', f'/{ns}/rslidar_points'),
        # ]
        remappings=[
            ('/odom_gt', f'/{ns}/odom'),
            ('/gps/fix', f'/{ns}/fix'),
    ...
    spawner_js = TimerAction(period=20.0, actions=[Node(
          package='controller_manager', executable='spawner', output='screen',
          arguments=['--controller-manager-timeout', '120', 'joint_states_controller'],
          parameters=[{'use_sim_time': use_sim_time}])])
    
    spawner_effort = TimerAction(period=30.0, actions=[Node(
        package='controller_manager', executable='spawner', output='screen',
