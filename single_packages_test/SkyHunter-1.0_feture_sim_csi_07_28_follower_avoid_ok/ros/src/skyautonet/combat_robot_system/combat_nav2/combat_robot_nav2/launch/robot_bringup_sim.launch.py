...
def launch_setup(context, *args, **kwargs):
    ...
    exec_params = {'use_sim_time': use_sim_time,
                   ...
                   'formation.lidar_self_range_m': float(LaunchConfiguration('formation_lidar_self_range_m').perform(context)),
                    'formation.obstacle_z_min_m': float(LaunchConfiguration('formation_obstacle_z_min_m').perform(context)),
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('formation_lidar_self_range_m', default_value='1.5'),
        DeclareLaunchArgument('formation_obstacle_z_min_m',   default_value='0.15'),
