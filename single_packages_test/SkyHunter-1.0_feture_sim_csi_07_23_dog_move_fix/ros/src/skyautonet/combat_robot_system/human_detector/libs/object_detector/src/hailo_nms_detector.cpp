...
HailoNmsDetector::HailoNmsDetector(std::string hef_path, float box_thres, bool show_info) : m_box_thres(box_thres) {
...
HailoNmsDetector::HailoNmsDetector(HailoNmsDetector&& other) noexcept : m_box_thres(other.m_box_thres) {
...
HailoNmsDetector& HailoNmsDetector::operator=(HailoNmsDetector&& other) noexcept {
    if (this != &other) {
...
std::vector<object_t> HailoNmsDetector::DecodeHailoNms(std::vector<uint8_t>& data, hailo_nms_shape_t nms_info,
...
std::vector<object_t> HailoNmsDetector::infer(image_ptr image_ptr, float image_width, float image_height) {
...
cv::Size2f HailoNmsDetector::get_input_size(size_t idx) {
